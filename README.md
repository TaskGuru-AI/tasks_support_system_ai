...
- `just setup` для локальной проверки (структура файлов)
- `just full-setup` для полной проверки и запуска синхронизации (установка зависимостей, синхронизация данных)
...
- `dvc commit -m 'Commit message to data'` и `just push-data` для обновления данных
